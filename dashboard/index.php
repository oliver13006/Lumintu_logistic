      ...
      <div class="home-content">
        ...
        <section class="customer-logos slider">
          <?php
              ...
              (sum(distinct(merch_eligibility.quantity)) - count(customer_x_merch.id_ticket)) as sisa_merch_dibagi from merch, merch_eligibility, 
              customer_x_merch, customer_x_merch_eligible where merch.id = merch_eligibility.merch_id 
              and customer_x_merch.id_ticket = merch_eligibility.id_ticket and customer_x_merch_eligible.id = merch_eligibility.id group by merch.id;");
